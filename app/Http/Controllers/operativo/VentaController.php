...
class VentaController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('operativo.cruds.ventas.index', compact('ventas', 'clientes', 'usuarios'));
    }
    ...
    public function create() {
        ...
        return view('operativo.cruds.ventas.create', compact('clientes', 'usuarios', 'productos'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('operativo.cruds.ventas.index')->with('success', 'Venta creada correctamente');
    }
   ...
   public function edit($id)
    {
        ...
        return view('operativo.cruds.ventas.edit', compact('venta', 'clientes', 'usuarios'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('operativo.cruds.ventas.index')->with('success', 'Venta actualizada correctamente');
    }
    public function toggle($id){
                $venta = Venta::findOrFail($id);
                $venta->Activo = !$venta->Activo;
                $venta->save();
                return redirect()->route('operativo.cruds.ventas.index')->with('success', 'Estado de la venta actualizado');
    }
