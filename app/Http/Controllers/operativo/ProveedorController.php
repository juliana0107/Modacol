...
class ProveedorController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('operativo.cruds.proveedores.index', compact('proveedores'))
            ->with('filters', $request->only(['RazonSocial', 'Correo', 'Direccion', 'Activo']));
    }

    public function create()
    {
        return view('operativo.cruds.proveedores.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('operativo.cruds.proveedores.edit', compact('proveedor'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('operativo.cruds.proveedores.index')
