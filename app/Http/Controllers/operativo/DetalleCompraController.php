    ...
    public function index(Request $request)
{
    ...
    public function create($compraId)
    {
        ...
        return view('operativo.cruds.detalle_compras.create', compact('compra', 'productos'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('operativo.cruds.detalle_compras.edit', compact('detalle', 'productos'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('operativo.cruds.detalle_compras.index')->with('success', 'Detalle de compra actualizado correctamente');
    }
   ...
   public function toggle($id)
    {
        ...
        $detalle->save();
        return redirect()->route('operativo.cruds.detalle_compras.index');
    }
