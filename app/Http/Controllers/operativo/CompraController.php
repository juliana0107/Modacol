    ...
    public function index(Request $request)
{
    ...
    return view('operativo.cruds.compras.index', compact('compras', 'proveedores', 'usuarios', 'productos'));
}
    ...
    public function create()
    {
        ...
        return view('operativo.cruds.compras.create', compact('proveedores', 'productos'));
    }
   ...
   public function store(Request $request)
{
    ...
    return redirect()->route('operativo.cruds.compras.index')
    ...
    public function show($id)
    {
        ...
        return view('operativo.cruds.compras.show', compact('compra'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('operativo.cruds.compras.edit', compact('compra', 'proveedores', 'productos'));
    }
     ...
     public function toggle($id)
{
    ...
    return redirect()->route('operativo.cruds.compras.index')->with('success', 'Estado de la compra actualizado');
}
