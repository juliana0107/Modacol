...
<div class="d-flex justify-content-between align-items-center mb-4">
    <a href="{{ route('operativo.cruds.clientes.create') }}" class="btn btn-primary">
...
<form method="GET" action="{{ route('operativo.cruds.clientes.index') }}" class="d-flex mb-4">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="table-actions text-center">
                    <a href="{{ route('operativo.cruds.clientes.edit', $cliente->Id) }}" class="btn btn-warning btn-sm" title="Editar">
